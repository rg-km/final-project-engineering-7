...
function StoriesCard({id, description, username, avatar}) {
    const fileAvatar = avatar.split('/');
    ...
    return (<Card border='light' style={{
        ...
        <div className='stories-profile d-flex'>
            <Image src={'https://salurin-backend.herokuapp.com/images/' + fileAvatar[2]} className="rounded-circle mr-2" width={50} height={50}></Image>
